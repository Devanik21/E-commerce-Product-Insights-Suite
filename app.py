...
try:
    ...
    with tab3:
        ...
        with st.expander("💰 Financial & Order Metrics (FOM)", expanded=False):
            ...
            st.markdown("---") # This markdown is inside the FOM expander, after FOM 8.
    # End of the "Financial & Order Metrics (FOM)" expander block.
    # The new tools will now be at the same level as the FOM expander.
        st.markdown("---") # Separator after the FOM expander and before the new tools.
