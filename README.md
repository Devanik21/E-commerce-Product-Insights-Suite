...
![Language](https://img.shields.io/badge/Language-Python-3776AB?style=flat-square) ![Stars](https://img.shields.io/github/stars/Devanik21/E-commerce-Product-Insights-Suite?style=flat-square&color=yellow) ![Forks](https://img.shields.io/github/forks/Devanik21/E-commerce-Product-Insights-Suite?style=flat-square&color=blue) ![Author](https://img.shields.io/badge/Author-Devanik21-black?style=flat-square&logo=github) ![Status](https://img.shields.io/badge/Status-Active-brightgreen?style=flat-square)

> E Commerce Product Insights Suite — an intelligent, interactive ML application built for real-world prediction and analysis.

---

**Topics:** `machine-learning` · `deep-learning` · `customer-analytics` · `data-science` · `e-commerce` · `nlp` · `plotly` · `recommendation-system` · `sentiment-analysis` · `streamlit`

## Overview

E Commerce Product Insights Suite is a machine learning web application built on Streamlit that provides a clean, accessible interface for a trained predictive model. The application takes structured user input, preprocesses it through a scikit-learn Pipeline, and returns model predictions with confidence scores and explanatory visualisations.
...
> **Key packages detected in this repo:** `statsmodels` · `google-generativeai` · `streamlit` · `pandas` · `numpy` · `seaborn` · `mlxtend` · `matplotlib` · `scikit-learn` · `pymc`
...
```bash
git clone https://github.com/Devanik21/E-commerce-Product-Insights-Suite.git
cd E-commerce-Product-Insights-Suite
...
├── requirements.txt
├── app.py
├── Amazon_Sale_Report_Sampled.csv
├── FashionDataset.csv
└── ...
```
